...
$lang = array
(
    'file_not_found'    => 'El archivo especificado, %s, no ha sido encontrado.' .
        ' Por favor, verifica que el fichero existe utilizando file_exists() antes de intentar utilizarlo.',
